...
{
    public partial class FrmReportHoaDonMH : Form
    {
        public FrmReportHoaDonMH()
        {
            InitializeComponent();
        }

        private void FrmReportHoaDonMH_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ReportDataSource rds = new ReportDataSource("DataSetHDMH", hangHoaTable);
                reportViewer1.LocalReport.DataSources.Add(rds);

                // Set the report embedded resource
                reportViewer1.LocalReport.ReportEmbeddedResource = "DOANWINFORM.Class.ReportHDMH.rdlc";
